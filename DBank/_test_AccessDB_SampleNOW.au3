...
$s_FilePath = "\\fileserver-fhu\edv\Inventory-Datenbank\NetworkCommon.mdb"
$s_TableName = 'dbo_DevicesALL'
$s_FieldName1 = 'Type'
$s_FieldName2 = 'HostName'
$s_Record = 2
; PROGRAM DATA
$s_Query = ''
$Options = False
...
$o_object.CreateDatabase($s_FilePath, ';LANGID=0x0409;CP=1252;COUNTRY=0') 		; ";LANGID=0x0409;CP=1252;COUNTRY=0" for English, German, French, Portuguese, Italian, and Modern Spanish

;$conn = ObjCreate("ADODB.Connection")
;$cat = ObjCreate("ADOX.Catalog")
;$tbl = ObjCreate("ADOX.Table")

$AccessRoot = $o_object.OpenDatabase($s_FilePath, $Options, $ReadOnly)
;$AccessRoot=$conn.Open("Driver={Microsoft Access Driver (*.mdb)};" & "DBQ=" & $s_FilePath )
