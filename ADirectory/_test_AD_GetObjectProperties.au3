...
; *****************************************************************************
$aProperties = _AD_GetObjectProperties("TrutanSa")
_ArrayDisplay($aProperties, "Active Directory Functions - Example 1 - Properties for user '" & "TrutanSa" & "'")

; *****************************************************************************
; Example 2
; Display only selected properties for the current user
; *****************************************************************************
$aProperties = _AD_GetObjectProperties("TrutanSa", "displayname,distinguishedName")
_ArrayDisplay($aProperties, "Active Directory Functions - Example 2 - Properties for user '" & "TrutanSa" & "'")
...
; *****************************************************************************
Global $aUser
$aUser = _AD_GetUserGroups("TrutanSa")
If $aUser[0] = 0 Then
	MsgBox(64, "Active Directory Functions - Example 4", "User '" & "TrutanSa" & "' is not a member of any group")
Else
